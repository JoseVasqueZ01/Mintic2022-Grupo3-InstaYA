  ...
  return (
    <div>
      ...
      <br></br>
            ...
            <h1 class="p-3 fs-2 border-top border-3"> <span class="text-primary">Estamos por encima del resto</span></h1>
          </section>
      <main>
          ...
          <div className="row">
              <div className="col-sm-6">
                <div className="card" id="Comunicado">
                  <img src="../img/Domi.png" className="card-img-top" alt="imagen 5"/>
